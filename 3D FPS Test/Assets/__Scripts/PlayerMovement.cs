...
public class PlayerMovement : MonoBehaviour
{
    ...
    // Player Cam and Orientation rotations
    ...
    private void Movement()
    {
        ...
        if (horz > 0 && xMag > maxSpeed) horz = 0;
        if (horz < 0 && xMag < -maxSpeed) horz = 0;
        if (vert > 0 && yMag > maxSpeed) vert = 0;
        if (vert < 0 && yMag < -maxSpeed) vert = 0;
        ...
        rb.AddForce(orientation.transform.forward * vert * moveSpeed * Time.deltaTime * multiplier * multiplierV);
        rb.AddForce(orientation.transform.right * horz * moveSpeed * Time.deltaTime * multiplier);
    }
    ...
    private void OnCollisionStay(Collision other)
    {
        ...
        // << operator bit shifts to check the layer in computer numbers
